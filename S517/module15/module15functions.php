...
<html lang="en">
    ...
    <body>
        ...
        <div class="topnav"> 
            ...
            <a class="active" href="module15functions.php">Play</a>
            <a href="module15form.php">Register</a>
            <a href="module15search.php">Scoreboard</a>
        ...
        ?>
            ...
            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="GET">
                ...
                <fieldset>
                    ...
                    <label for="yob">Enter your year of birth:</label><br>
                    <input type="number" name="yob" id="yob" min="1900" max="<?php echo CURRENTYEAR; ?>" required><br>
